const jsonUrl = 'https://raw.githubusercontent.com/Ioketh/JSON/refs/heads/main/Data.json';
//https://raw.githubusercontent.com/UhuruDannie/JSON/refs/heads/main/data.json
...
fetch(jsonUrl)
    ...
    function visualizeData(data) {
        ...
        const genderCounts = allStudents.reduce((counts, students) => {
            counts[students.gender] = (counts[students.gender] || 0) + 1;
            return counts;
        }, {});
